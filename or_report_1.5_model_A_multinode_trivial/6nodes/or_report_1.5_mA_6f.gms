...
$Ondelim
$Include or_report.1.5_cost_mA_6f.csv
$Offdelim
;
Table maxflow(i,j) "maxflow of tube"
$Ondelim
$Include or_report.1.5_maxflow_mA_6f.csv
$Offdelim
;
...
*$ontext
*gdx2csv
$call gdxdump or_report.1.5_mA_6f.gdx symb=cost CSVSetText format=csv header = "cost(iter)">> or_report.1.5_mA_6f_out_cost.csv
$call gdxdump or_report.1.5_mA_6f.gdx symb=isfeasible CSVSetText format=csv header = "isfeasible(iter)">> or_report.1.5_mA_6f_out_isfeasible.csv
$call gdxdump or_report.1.5_mA_6f.gdx symb=remain CSVSetText format=csv header ="remain(iter)">> or_report.1.5_mA_6f_out_remain.csv
$call gdxdump or_report.1.5_mA_6f.gdx symb=remainrate CSVSetText format=csv header = "remainrate(iter)">> or_report.1.5_mA_6f_out_remainrate.csv
*$offtext