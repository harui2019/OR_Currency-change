Sets
    node "node" /a, b, c, d, e, f, g/
    iter "loop from 1 to infeasible" /1*1200/
;
alias (node, i, j)
;
...
$Ondelim
$Include or_report.1.6_cost_mB_7g.csv
$Offdelim
;
Table maxflow(i,j) "maxflow of tube"
$Ondelim
$Include or_report.1.6_maxflow_mB_7g.csv
$Offdelim
...
;
Parameters
    w_on(node) "" /a 1, b 0, c 0, d 0, e 0, f 0, g 0/,
    f_on(node) "" /a 0, b 0, c 0, d 0, e -1, f 0, g 0/,
    c(i,j) "" ,
...
*$ontext
*gdx2csv
$call gdxdump or_report.1.6_mB_7g.gdx symb=cost CSVSetText format=csv header = "cost(iter)">> or_report.1.6_mB_7g_out_cost.csv
$call gdxdump or_report.1.6_mB_7g.gdx symb=isfeasible CSVSetText format=csv header = "isfeasible(iter)">> or_report.1.6_mB_7g_out_isfeasible.csv
$call gdxdump or_report.1.6_mB_7g.gdx symb=remain CSVSetText format=csv header ="remain(iter)">> or_report.1.6_mB_7g_out_remain.csv
$call gdxdump or_report.1.6_mB_7g.gdx symb=remainrate CSVSetText format=csv header = "remainrate(iter)">> or_report.1.6_mB_7g_out_remainrate.csv
*$offtext