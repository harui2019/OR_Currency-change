...
$Ondelim
$Include or_report.1.6_maxflow_mB_6f.csv
$Offdelim
;

Table c_down(i,j)
$Ondelim
$Include or_report.1.6_cost_mB_6f.csv
$Offdelim
...
*$ontext
*gdx2csv
$call gdxdump or_report.1.6_mB_6f.gdx symb=cost CSVSetText format=csv header = "cost(iter)">> or_report.1.6_mB_6f_out_cost.csv
$call gdxdump or_report.1.6_mB_6f.gdx symb=isfeasible CSVSetText format=csv header = "isfeasible(iter)">> or_report.1.6_mB_6f_out_isfeasible.csv
$call gdxdump or_report.1.6_mB_6f.gdx symb=remain CSVSetText format=csv header ="remain(iter)">> or_report.1.6_mB_6f_out_remain.csv
$call gdxdump or_report.1.6_mB_6f.gdx symb=remainrate CSVSetText format=csv header = "remainrate(iter)">> or_report.1.6_mB_6f_out_remainrate.csv
*$offtext