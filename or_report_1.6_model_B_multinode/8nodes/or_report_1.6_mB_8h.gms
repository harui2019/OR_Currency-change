...
$Ondelim
$Include or_report.1.6_cost_mB_8h.csv
$Offdelim
;
Table maxflow(i,j) "maxflow of tube"
$Ondelim
$Include or_report.1.6_maxflow_mB_8h.csv
$Offdelim
...
;
Parameters
    w_on(node) "" /a 1, b 0, c 0, d 0, e 0, f 0, g 0, h 0/,
    f_on(node) "" /a 0, b 0, c 0, d 0, e -1, f 0, g 0, h 0/,
    c(i,j) "" ,
...
*$ontext
*gdx2csv
$call gdxdump or_report.1.6_mB_8h.gdx symb=cost CSVSetText format=csv header = "cost(iter)">> or_report.1.6_mB_8h_out_cost.csv
$call gdxdump or_report.1.6_mB_8h.gdx symb=isfeasible CSVSetText format=csv header = "isfeasible(iter)">> or_report.1.6_mB_8h_out_isfeasible.csv
$call gdxdump or_report.1.6_mB_8h.gdx symb=remain CSVSetText format=csv header ="remain(iter)">> or_report.1.6_mB_8h_out_remain.csv
$call gdxdump or_report.1.6_mB_8h.gdx symb=remainrate CSVSetText format=csv header = "remainrate(iter)">> or_report.1.6_mB_8h_out_remainrate.csv
*$offtext