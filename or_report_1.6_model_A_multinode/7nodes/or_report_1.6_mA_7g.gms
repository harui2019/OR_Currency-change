...
$Ondelim
$Include or_report.1.6_cost_mA_7g.csv
$Offdelim
;
Table maxflow(i,j) "maxflow of tube"
$Ondelim
$Include or_report.1.6_maxflow_mA_7g.csv
$Offdelim
;
...
*$ontext
*gdx2csv
$call gdxdump or_report.1.6_mA_7g.gdx symb=cost CSVSetText format=csv header = "cost(iter)">> or_report.1.6_mA_7g_out_cost.csv
$call gdxdump or_report.1.6_mA_7g.gdx symb=isfeasible CSVSetText format=csv header = "isfeasible(iter)">> or_report.1.6_mA_7g_out_isfeasible.csv
$call gdxdump or_report.1.6_mA_7g.gdx symb=remain CSVSetText format=csv header ="remain(iter)">> or_report.1.6_mA_7g_out_remain.csv
$call gdxdump or_report.1.6_mA_7g.gdx symb=remainrate CSVSetText format=csv header = "remainrate(iter)">> or_report.1.6_mA_7g_out_remainrate.csv
*$offtext